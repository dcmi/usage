...
tags: []
aliases:
- "/usage/decisions/2000/creator-contrib-publisher-20000401-remarks-lundberg.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td>Sigfrid Lundberg</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>April 13, 2000 12:45 PM</td>
</tr>
</tbody>
</table>

<pre>I find it meaningless to vote on this one. I reject the proposal in inte
entirety.</pre>
  <form action="/servlets/voting/dc/2dcq6?t=38" method="post">
