...
tags: []
aliases:
- "/usage/decisions/2000/contrib-creator-publisher-agents-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      <p></p>
      <h2>Detailed info on settings</h2>
      <table cellpadding="2">
        <tbody>
        <tr valign="top">
          <td><b>Status: </b></td>
        ...
        <tr valign="top">
          ...
          <td colspan="3">Micsik András</td>
</tr>
        <tr valign="top">
          <td><b>Voters: </b></td>
          
      <td colspan="3">
<a href="contrib-creator-publisher-agents-voters.htm">33 member(s)</a> 
      </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="contrib-creator-publisher-agents-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
      <ul>Languages: English <br>Open Vote <br>Changing vote allowed <br>Start 
        collecting immediately <br>Stopping collection: latest stop at 2/11/00 
        10:00 PM <br>Result is continuously updated on server (in verbose 
        format) </ul>
      
  <form action="/servlets/voting/dc/dcq6?t=12" method="post">
