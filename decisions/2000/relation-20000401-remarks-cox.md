...
tags: []
aliases:
- "/usage/decisions/2000/relation-20000401-remarks-cox.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      <p></p>
      <h2>scheme for relation refiners</h2>
      <table cellpadding="2">
        <tbody>
        <tr valign="top">
          <td>From: </td>
      ...
      <td>Simon Cox</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>April 5, 2000 3:02 AM</td>
</tr>
</tbody>
</table>

<pre>The list of 12 element refiners (does this include all the Helsinki 12? I
think not as "replaces/replacedBy" has been added) should 
 be given a name
and recognised as a scheme. </pre>
  <form action="/servlets/voting/dc/2dcq4?t=39" method="post">
