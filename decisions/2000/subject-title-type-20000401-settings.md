...
tags: []
aliases:
- "/usage/decisions/2000/subject-title-type-20000401-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3"><a href="subject-title-type-20000401-observers.htm">35 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/2dcq5?t=50" method="post">
