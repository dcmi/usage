...
tags: []
aliases:
- "/usage/decisions/2000/descript-format-identifier-lang-20000401-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <table cellpadding="2">
        ...
        <tr valign="top">
          <td><b>Voters: </b></td>
          <td colspan="3">Observers </td>
</tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="descript-format-identifier-lang-20000401-observers.htm">35 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
      <ul>Languages: English <br>Open Vote <br>Changing vote allowed <br>Start 
        collecting immediately <br>Stopping collection: latest stop at 4/15/00 
        7:00 PM <br>Result is continuously updated on server (in verbose format) 
      </ul>
      
  <form action="/servlets/voting/dc/2dcq3?t=14" method="post">
