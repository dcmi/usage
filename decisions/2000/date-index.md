...
tags: []
aliases:
- "/usage/decisions/2000/date-index.htm"
notes: 
annotation: 
---
...
<font size="+1"><b><!--line1--></b></font>You can observe the 
    ...
    <tr valign="top"> 
      <td>
<b><a href="date-results.htm">Final result</a><br>
        <a href="date-settings.htm">Detailed info on settings</a><br>
        <a href="date-questionnaire.htm">Questionnaire (preview)</a><br>
        <a href="date-log.htm">Log of important actions</a></b> </td>
      <td>
