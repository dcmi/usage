...
tags: []
aliases:
- "/usage/decisions/2000/date-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3">
<a href="date-voters.htm">33 member(s)</a> </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="date-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/dcq1?t=41" method="post">
