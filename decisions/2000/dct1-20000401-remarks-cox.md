...
tags: []
aliases:
- "/usage/decisions/2000/dct1-20000401-remarks-cox.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      <p></p>
      <h2>DCT1 vs. rigorous ontologies</h2>
      <table cellpadding="2">
        <tbody>
        <tr valign="top">
          <td>From: </td>
      ...
      <td>Simon Cox</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>April 5, 2000 3:10 AM</td>
</tr>
</tbody>
</table>

<pre>The list of "types" in DCT1 is not a proper ontology - 
 the discriminants
are not consistent or complete (or even 
 explained properly!) so some
resources would fit in more 
 than one slot. Nevertheless, some sense of
"type" seems 
 to strike a chord with most users, and this list could 
serve as "hints for searching". </pre>
  <form action="/servlets/voting/dc/dct1?t=9" method="post">
