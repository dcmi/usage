...
tags: []
aliases:
- "/usage/decisions/2000/relation-remarks-lundberg.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      <p></p>
      <h2>Lacking reciprocal relations</h2>
      <table cellpadding="2">
        <tbody>
        <tr valign="top">
          <td>From: </td>
      ...
      <td>Sigfrid Lundberg</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>January 31, 2000 11:13 AM</td>
</tr>
</tbody>
</table>

<pre>I noticed that some of the relations were stripped, such that in some cases
the reciprocal relation was abscent.
 
 Sigge
 </pre>
  <form action="/servlets/voting/dc/dcq4?t=32" method="post">
