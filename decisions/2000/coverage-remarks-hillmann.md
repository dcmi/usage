...
tags: []
aliases:
- "/usage/decisions/2000/coverage-remarks-hillmann.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td>Diane Hillmann</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>January 23, 2000 10:57 PM</td>
</tr>
</tbody>
</table>

<pre>The Coverage proposal seems to be at:
http://www.mailbase.ac.uk/lists/dc-coverage/files/wd-coverage-qual.htm not
at the URL on the voting page.</pre>
  <form action="/servlets/voting/dc/dcq2?t=24" method="post">
