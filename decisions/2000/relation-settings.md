...
tags: []
aliases:
- "/usage/decisions/2000/relation-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3">
<a href="relation-voters.htm">33 member(s)</a> </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="relation-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/dcq4?t=27" method="post">
