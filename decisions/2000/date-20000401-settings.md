...
tags: []
aliases:
- "/usage/decisions/2000/date-20000401-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3"><a href="date-20000401-observers.htm">35 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/2dcq1?t=6" method="post">
