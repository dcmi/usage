...
tags: []
aliases:
- "/usage/decisions/2000/coverage-index.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      <p></p>The ballot is based on the following working group proposal: 
      <dl>
        <dt>Coverage 
...
<font size="+1"><b><!--line1--></b></font>You can observe the 
    ...
    <tr valign="top"> 
      <td>
<b><a href="coverage-results.htm">Final result</a><br>
        <a href="coverage-settings.htm">Detailed info on settings</a><br>
        <a href="coverage-questionnaire.htm">Questionnaire (preview)</a><br>
        <a href="coverage-log.htm">Log of important actions</a></b> </td>
      <td>
...
<b><font size="+1">Remarks</font></b> <br><font size="-1">This is a 
      ...
      <td nowrap><a href="coverage-remarks-hillmann.htm">URL correction?</a></td>
          <td>1/23/00 10:57 PM</td>
          <td>hillmann</td>
</tr>
        <tr valign="top">
          
      <td nowrap><a href="coverage-remarks-micsik.htm">Re: URL correction?</a></td>
          <td>1/24/00 12:50 PM</td>
          <td>micsik</td>
</tr>
</tbody>
</table>
