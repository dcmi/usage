...
tags: []
aliases:
- "/usage/decisions/2000/subject-title-type-remarks-childress.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td>Eric Childress</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>February 2, 2000 10:41 PM</td>
</tr>
</tbody>
</table>

<pre>It would be helpful to add Library of Congress Classification as an
encoding scheme.</pre>
  <form action="/servlets/voting/dc/dcq5?t=47" method="post">
