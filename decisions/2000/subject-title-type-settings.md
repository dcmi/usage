...
tags: []
aliases:
- "/usage/decisions/2000/subject-title-type-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3">
<a href="subject-title-type-voters.htm">33 member(s)</a> </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="subject-title-type-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/dcq5?t=42" method="post">
