...
tags: []
aliases:
- "/usage/decisions/2000/coverage-remarks-micsik.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td>Micsik András</td>
        ...
        <tr valign="top">
          <td>Date: </td>
          <td>January 24, 2000 12:50 PM</td>
</tr>
</tbody>
</table>

<pre>Thanks, I corrected the URL.
 
 Andras Micsik
 </pre>
  <form action="/servlets/voting/dc/dcq2?t=25" method="post">
