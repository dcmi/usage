...
tags: []
aliases:
- "/usage/decisions/2000/coverage-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3">
<a href="coverage-voters.htm">33 member(s)</a> </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="coverage-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/dcq2?t=19" method="post">
