...
tags: []
aliases:
- "/usage/decisions/2000/descript-format-lang-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3">
<a href="descript-format-lang-voters.htm">33 member(s)</a> </td>
    </tr>
        <tr valign="top">
          <td><b>Observers: </b></td>
          
      <td colspan="3"><a href="descript-format-lang-observers.htm">33 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/dcq3?t=20" method="post">
