...
tags: []
aliases:
- "/usage/decisions/2000/coverage-20000401-settings.htm"
notes: 
annotation: 
---
...
--><!-- header end -->
      ...
      <td colspan="3"><a href="coverage-20000401-observers.htm">35 member(s)</a></td>
    </tr>
</tbody>
</table>
...
<h3>Control script</h3>
  ...
  <form action="/servlets/voting/dc/2dc2?t=28" method="post">
